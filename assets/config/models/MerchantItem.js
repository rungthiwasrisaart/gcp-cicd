module.exports = function (nameDB, mongoose, isConnect, mongoDB) {
    ...
    let schema = new Schema({
        ...
        itemName: {
            type: String,
            required: [true, 'Require field input item name.']
        },
        itemInfo: {
            type: String,
            required: [true, 'Require field input item info.']
        },
        itemPrice: {
            type: Number,
            required: [true, 'Require field input item price.']
        },
        itemImage: {
            type: String,
            required: [true, 'Require field input item image.']
        }
    }, {
        timestamps: {
    ...
    return connectDatabase.model('merchant_items', schema)
}